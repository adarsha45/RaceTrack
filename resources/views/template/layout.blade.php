...
<!-- Content Wrapper. Contains page content -->
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <!-- using a bootstrap container - https://getbootstrap.com/docs/4.0/layout/overview/ -->
            <div class="container-fluid">
                <!-- using a bootstrap row - https://getbootstrap.com/docs/4.0/layout/grid/ -->
                <div class="row mb-2">
    ...
    <!-- Main Footer -->
    <footer class="main-header font-small mdb-color lighten-3 pt-4 bg-black">
        <!-- As above the container, row and column are all from bootstrap -->
        <!-- Footer Elements -->
        <div class="container">
